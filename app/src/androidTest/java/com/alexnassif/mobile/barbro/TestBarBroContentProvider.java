...
import com.alexnassif.mobile.barbro.data.BarBroContentProvider;
import com.alexnassif.mobile.barbro.data.BarBroContract;
import com.alexnassif.mobile.barbro.data.BarBroDbHelper;
...
public class TestBarBroContentProvider {
    ...
    public void setUp() {
        ...
        BarBroDbHelper dbHelper = new BarBroDbHelper(mContext);
        SQLiteDatabase database = dbHelper.getWritableDatabase();
        database.delete(BarBroContract.BarBroEntry.TABLE_NAME, null, null);
    }
    ...
    public void testProviderRegistry() {
        ...
        String taskProviderClassName = BarBroContentProvider.class.getName();
        ...
        try {
            ...
            String incorrectAuthority =
                    "Error: BarBroContentProvider registered with authority: " + actualAuthority +
            ...
            String providerNotRegisteredAtAll =
                    "Error: BarBroContentProvider not registered at " + mContext.getPackageName();
            /*
    ...
    public void testUriMatcher() {
        ...
        UriMatcher testMatcher = BarBroContentProvider.buildUriMatcher();
